(function($) {
	...
	if ($('.single-item-carousel').length) {
		$('.single-item-carousel').owlCarousel({
			...
			smartSpeed: 500,
			autoplay: 1000,
			navText: [ '<span class="icon-42"></span>', '<span class="icon-43"></span>' ],
			responsive:{
				0:{
					items:1
				},
	...
	// shop-carousel-2
	if ($('.shop-carousel-2').length) {
		$('.shop-carousel-2').owlCarousel({
			loop:true,
			margin:0,
			nav:true,
			smartSpeed: 500,
	...
	// shop-carousel-3
	if ($('.shop-carousel-3').length) {
		$('.shop-carousel-3').owlCarousel({
			loop:true,
			margin:20,
			nav:true,
			smartSpeed: 500,
	...
	// category-carousel-2
	if ($('.category-carousel-2').length) {
		$('.category-carousel-2').owlCarousel({
			loop:true,
			margin:60,
			nav:true,
			smartSpeed: 500,
	...
	if($('.timer').length){
	   ...
	   $('.cs-countdown').countdown('').on('update.countdown', function(event) {
		  var $this = $(this).html(event.strftime('<div class="count-col"><span>%D</span><h6>d</h6></div> <div class="count-col"><span>%H</span><h6>H</h6></div> <div class="count-col"><span>%M</span><h6>M</h6></div> <div class="count-col"><span>%S</span><h6>S</h6></div>'));
		});
	}
	...
	//shopping-cart-bar
	$(".shopping-cart-one").on("click", function () {
		$(".cart-menu-one").addClass('cart-visible');
	});
	$(".close-icon-one").click(function () {
		$(".cart-menu-one").removeClass('cart-visible');
  ...
  if ($('.shop-details .bxslider').length) {
	...
	$(".shop-filter-btn").on("click", function () {
		$(".shop-filter-content").addClass('cart-visible');
	});
	$(".filter-close-icon").click(function () {
		$(".shop-filter-content").removeClass('cart-visible');
